...
//       const jsonSchema = resolver.toJsonSchema(targetSchema)
...
//           in: openApiIn,
//           schema: propSchema,
//           required: required?.includes(name) || openApiIn === 'path',
//         }),
//       )
//     })
...
//     const parameters = schema ? buildParameters(schema) : undefined
...
//   const tags = controllers.flatMap((controller) => {
//     const metadata = asControllerMetadata(controller[Symbol.metadata])
//     const tag = metadata.openapi.tag
//     return tag ? [tag] : []
//   })

//   const components = compactObject({
